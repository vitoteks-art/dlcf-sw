ALTER TABLE biodata
  ...
  ADD COLUMN sanctification_status TINYINT(1) NOT NULL DEFAULT 0 AFTER new_birth_date,
  ADD COLUMN sanctification_date DATE NULL AFTER sanctification_status,
  ADD COLUMN holy_ghost_baptism_status TINYINT(1) NOT NULL DEFAULT 0 AFTER sanctification_date,
  ADD COLUMN holy_ghost_baptism_date DATE NULL AFTER holy_ghost_baptism_status,
  ADD COLUMN spiritual_notes TEXT NULL AFTER holy_ghost_baptism_date,
